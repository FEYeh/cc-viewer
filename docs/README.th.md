...
- ข้อความผู้ใช้จัดชิดซ้าย (ฟองสีน้ำเงิน)
- การตอบกลับของ Main Agent จัดชิดซ้าย (ฟองสีเทาเข้ม) พร้อมการแสดงผล Markdown
...
- บันทึก log ปัจจุบัน: ดาวน์โหลดไฟล์ log JSONL ที่กำลังตรวจสอบอยู่
