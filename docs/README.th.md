...
- ใช้ Claude Haiku API, ใช้การยืนยันตัวตนแบบ `x-api-key` เท่านั้น (ไม่ใช้ OAuth session token เพื่อป้องกันการปนเปื้อนบริบท)
- จับชื่อโมเดล haiku จากคำขอ mainAgent โดยอัตโนมัติ; ค่าเริ่มต้นคือ `claude-haiku-4-5-20251001`
- ผลการแปลถูกแคชอัตโนมัติ; คลิกอีกครั้งเพื่อสลับกลับไปยังข้อความต้นฉบับ
- แสดงแอนิเมชันโหลดระหว่างการแปล
- ไอคอน (?) ข้าง header `authorization` ในรายละเอียดคำขอเชื่อมไปยังเอกสารแนวคิดเกี่ยวกับการปนเปื้อนบริบท
