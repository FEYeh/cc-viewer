...
### วิธีการส่ง PR
ผู้เขียนยินดีรับ PR และสนับสนุนให้ชุมชนส่ง PR

ข้อกำหนดบางประการ:

เมื่อส่ง PR กรุณาบอกฉันว่า Prompt ของคุณคืออะไร และใช้โมเดลอะไรในการแก้ไขโค้ด (ไม่รับ PR ที่แก้ไขด้วยโมเดลคุณภาพต่ำ);
หากมีการเปลี่ยนแปลง UI กรุณาบอกว่าฟังก์ชันอะไรที่ถูกแก้ไขบนหน้าจอ — แนะนำให้ใช้ภาพหน้าจอพร้อมวงกลมล้อมรอบการเปลี่ยนแปลง;
การเปลี่ยนแปลงใน cli.js และ interceptor.js จะถูกตรวจสอบอย่างระมัดระวังมาก เพราะไม่ต้องการให้ปัญหาในไฟล์หลักส่งผลกระทบต่อการใช้งานของทุกคน;
กรุณาตรวจสอบฟังก์ชันการทำงานในเครื่องก่อนส่ง — ขอบคุณมากครับ!
