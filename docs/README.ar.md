...
### كيفية تقديم PR
يرحب المؤلف بطلبات PR ويشجع المجتمع على تقديمها.

بعض المتطلبات:

عند تقديم PR، يرجى إخباري ما هو الـ Prompt الذي استخدمته وأي نموذج استخدمته لتعديل الكود (لن يتم قبول PRs المعدلة بنماذج ضعيفة)؛
إذا كانت هناك تغييرات في الواجهة، أخبرني ما هي الوظيفة التي تم تعديلها — يُنصح بلقطة شاشة مع رسم دوائر حول التغييرات؛
سيتم مراجعة التغييرات في cli.js و interceptor.js بعناية شديدة، لأنني لا أريد أن تؤثر مشاكل الملفات الأساسية على استخدام الجميع؛
يرجى التأكد من التحقق من الوظائف محلياً قبل التقديم — شكراً جزيلاً!
