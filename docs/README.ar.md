...
- رسائل المستخدم محاذاة لليسار (فقاعات زرقاء)
- ردود Main Agent محاذاة لليسار (فقاعات رمادية داكنة) مع عرض Markdown
...
- حفظ السجل الحالي: تنزيل ملف سجل المراقبة JSONL الحالي
