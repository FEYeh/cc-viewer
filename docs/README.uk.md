...
```
Я встановив npm-пакет cc-viewer, але після запуску ccv він все ще не працює коректно. Перегляньте cli.js та findcc.js пакету cc-viewer і адаптуйте його до локального способу розгортання Claude Code відповідно до конкретного середовища. Намагайтеся обмежити зміни файлом findcc.js.
```
...
### Як надіслати PR
Автор із задоволенням приймає PR та заохочує спільноту їх надсилати.

Кілька вимог:

При надсиланні PR, будь ласка, повідомте мені, який був ваш Prompt та яку модель ви використовували для зміни коду (PR, зроблені за допомогою слабких моделей, не приймаються);
Якщо є зміни інтерфейсу, повідомте мені, яка функціональність була змінена — рекомендується скріншот з обведеними змінами;
Зміни в cli.js та interceptor.js будуть перевірятися дуже ретельно, оскільки я не хочу, щоб проблеми в основних файлах вплинули на використання всіма;
Будь ласка, обов'язково перевірте функціональність локально перед надсиланням — щиро дякую!
