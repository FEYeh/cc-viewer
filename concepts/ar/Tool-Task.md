...
ينتج استدعاء Task سلسلة طلبات SubAgent، يمكن رؤية تسلسل طلبات فرعية مستقلة عن MainAgent في قائمة الطلبات. عادة ما تتميز طلبات SubAgent بـ system prompt مختصر وتعريفات أدوات أقل، مما يشكل تبايناً واضحاً مع MainAgent.
