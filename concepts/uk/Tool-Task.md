...
Виклики Task створюють ланцюг запитів SubAgent; у списку запитів можна побачити послідовності підзапитів, незалежні від MainAgent. Запити SubAgent зазвичай мають скорочений system prompt та менше визначень інструментів, що створює помітний контраст з MainAgent.
