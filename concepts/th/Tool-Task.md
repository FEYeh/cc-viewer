...
การเรียก Task จะสร้างสายคำร้องขอ SubAgent ซึ่งสามารถเห็นในรายการคำร้องขอเป็นลำดับคำร้องขอย่อยที่แยกจาก MainAgent คำร้องขอ SubAgent มักมี system prompt แบบย่อและคำจำกัดความเครื่องมือน้อยกว่า ซึ่งแตกต่างอย่างชัดเจนจาก MainAgent
